...
1846 rows and 3 columns, variables = dataset, x, y
...
attach(star_data)
cor(x, y)
print("the dino correlation was stronger than the start correlation")
detach(star_data)
ggplot(star_data, mapping = aes(x=x, y=y)) +
  geom_point()
...
print("the dino correlation was stronger than the start correlation")
detach(circ_data)
ggplot(circ_data, mapping = aes(x=x, y=y)) +
  geom_point()
```
